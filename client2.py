...
train_it = traingen.flow_from_directory("D:/Federated/client2_data/train", target_size = (224, 224))
val_it = traingen.flow_from_directory("D:/Federated/client2_data/val", target_size = (224, 224))
test_it = traingen.flow_from_directory("D:/Federated/client2_data/test", target_size = (224, 224))
